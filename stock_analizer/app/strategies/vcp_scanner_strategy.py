...
async def get_data(symbol):
    """Download daily OHLCV data using Polygon API."""
    try:
        async with aiohttp.ClientSession() as session:
            ...
            if len(df) < 200:  # Need at least 200 days for 200-day MA
...
if __name__ == "__main__":
    ...
    async def full_scan():
        ...
        if vcp_candidates:
            ...
            # Print detailed VCP candidates
            print(f"\n🎯 DETAILED VCP CANDIDATES FOUND:")
            ...
            print("⚠️ No VCP candidates found in S&P 500")
